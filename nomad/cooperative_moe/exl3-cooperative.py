...
_coop_setup = _coop_runpy.run_path('/models/cooperative_moe/runtime.py')
_coop_setup["install"](_coop_sys.modules[__name__], library_root='/models/cooperative_moe', enabled=True)
